...
public class UserControllerTest {
	...
	@Test
	public void 未ログイン時の場合は会員用の会員詳細ページからログインページにリダイレクトする()
			throws Exception{
	...
	public void ログイン済みの場合は会員用の会員詳細ページが正しく表示される()
			throws Exception{
	...
	@Test
	@WithUserDetails("taro.samurai@example.com")
	public void ログイン済みの場合は会員用の会員編集ページが正しく表示される()
			throws Exception{
	...
	@Test
	@Transactional
	public void 未ログインの場合は会員を更新せずにログインページにリダイレクトする()
			throws Exception{
	...
	@WithUserDetails("taro.samurai@example.com")
	@Transactional
	public void ログイン済みの場合は会員更新後に会員用の会員詳細ページにリダイレクトする()
			throws Exception{
